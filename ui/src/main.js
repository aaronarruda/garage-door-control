...
var GlobalConfigs = require('./config/globalConfigs.js');
...
var apiUrl = "http://" + globalConfigs.server + "/cam_pic.php";
...
var Enclosure = React.createClass({
	...
	refreshPicture: function () {
		this.setState({key: Math.random(), url: apiUrl + "?key=" + this.state.key});
	},

	componentDidMount: function() {
		setInterval(this.refreshPicture, 10000);
	},
